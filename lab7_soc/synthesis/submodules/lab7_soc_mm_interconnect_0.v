...
module lab7_soc_mm_interconnect_0 (
		...
		input  wire [25:0] nios2_gen2_0_instruction_master_address,        //          nios2_gen2_0_instruction_master.address
	...
	wire  [101:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_data_master_agent:rp_data
	...
	wire  [101:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	...
	wire   [25:0] sysid_qsys_0_control_slave_agent_m0_address;                                        // sysid_qsys_0_control_slave_agent:m0_address -> sysid_qsys_0_control_slave_translator:uav_address
	...
	wire  [102:0] sysid_qsys_0_control_slave_agent_rf_source_data;                                    // sysid_qsys_0_control_slave_agent:rf_source_data -> sysid_qsys_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] sysid_qsys_0_control_slave_agent_rsp_fifo_out_data;                                 // sysid_qsys_0_control_slave_agent_rsp_fifo:out_data -> sysid_qsys_0_control_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire   [25:0] sdram_pll_pll_slave_agent_m0_address;                                               // sdram_pll_pll_slave_agent:m0_address -> sdram_pll_pll_slave_translator:uav_address
	...
	wire  [102:0] sdram_pll_pll_slave_agent_rf_source_data;                                           // sdram_pll_pll_slave_agent:rf_source_data -> sdram_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] sdram_pll_pll_slave_agent_rsp_fifo_out_data;                                        // sdram_pll_pll_slave_agent_rsp_fifo:out_data -> sdram_pll_pll_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [101:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [25:0] led_s1_agent_m0_address;                                                            // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [101:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire   [25:0] sdram_s1_agent_m0_address;                                                          // sdram_s1_agent:m0_address -> sdram_s1_translator:uav_address
	...
	wire  [101:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> sdram_s1_agent:cp_data
	...
	wire  [101:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [101:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [101:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [101:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [101:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> crosser_001:in_data
	...
	wire  [101:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_005:sink1_data
	...
	wire  [101:0] rsp_demux_005_src0_data;                                                            // rsp_demux_005:src0_data -> crosser_002:in_data
	...
	wire  [101:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink5_data
	...
	wire  [101:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> crosser_003:in_data
	...
	wire  [101:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink5_data
