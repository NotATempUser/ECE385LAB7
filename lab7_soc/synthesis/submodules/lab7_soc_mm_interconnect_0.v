...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [104:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	...
	wire  [104:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [105:0] sdram_pll_pll_slave_agent_rf_source_data;                                           // sdram_pll_pll_slave_agent:rf_source_data -> sdram_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] sdram_pll_pll_slave_agent_rsp_fifo_out_data;                                        // sdram_pll_pll_slave_agent_rsp_fifo:out_data -> sdram_pll_pll_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire   [28:0] led_s1_agent_m0_address;                                                            // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire   [28:0] sw_s1_agent_m0_address;                                                             // sw_s1_agent:m0_address -> sw_s1_translator:uav_address
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [105:0] keys_s1_agent_rf_source_data;                                                       // keys_s1_agent:rf_source_data -> keys_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] keys_s1_agent_rsp_fifo_out_data;                                                    // keys_s1_agent_rsp_fifo:out_data -> keys_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> keys_s1_agent:cp_valid
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> keys_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> keys_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> keys_s1_agent:cp_endofpacket
	...
	wire  [104:0] nios2_gen2_0_instruction_master_agent_cp_data;                                      // nios2_gen2_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [104:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [104:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [104:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_008:sink_data
	...
	wire          keys_s1_agent_rp_valid;                                                             // keys_s1_agent:rp_valid -> router_009:sink_valid
	wire  [104:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_009:sink_data
	wire          keys_s1_agent_rp_ready;                                                             // router_009:sink_ready -> keys_s1_agent:rp_ready
	wire          keys_s1_agent_rp_startofpacket;                                                     // keys_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          keys_s1_agent_rp_endofpacket;                                                       // keys_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [104:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [104:0] cmd_demux_001_src7_data;                                                            // cmd_demux_001:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [104:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink6_data
	...
	wire  [104:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink7_data
	...
	wire          sw_s1_agent_rdata_fifo_src_valid;                                                   // sw_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] sw_s1_agent_rdata_fifo_src_data;                                                    // sw_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          sw_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_006:in_0_ready -> sw_s1_agent:rdata_fifo_src_ready
	...
	wire          keys_s1_agent_rdata_fifo_src_valid;                                                 // keys_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] keys_s1_agent_rdata_fifo_src_data;                                                  // keys_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          keys_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> keys_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> keys_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> keys_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // keys_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> keys_s1_agent:rdata_fifo_sink_error
	...
	lab7_soc_mm_interconnect_0_router_002 router_007 (
